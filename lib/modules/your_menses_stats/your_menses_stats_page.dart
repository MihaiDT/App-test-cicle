...
class YourMensesStatsPage extends GetView<YourMensesStatsController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => appController.periodsStats.responseHandler.isPending
            ? Center(
                child: SizedBox(
                  height: 40,
                  width: 40,
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          ...
                          child: SingleMensesSection(
                            startingDate:
                                controller.periodsStats[index].startingDate,
                            endingDate:
                                controller.periodsStats[index].endingDate,
                            periodDuration:
                                controller.periodsStats[index].periodDuration,
                            mensesDays:
                                controller.periodsStats[index].menstruationDays,
                            ovulationDays:
                                controller.periodsStats[index].ovulationDays,
                          ),
                        );
                      },
