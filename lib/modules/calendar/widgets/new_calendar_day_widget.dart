...
class NewCalendarDayWidget extends StatelessWidget {
  final NewSingleDayData? singleDayData;
  ...
  Widget _dayContainer(BuildContext context) {
    if (singleDayData != null) {
      ...
      } else if (singleDayData!.periodPhase == PeriodPhase.ovulation) {
        return DottedBorder(
